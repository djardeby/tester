...
//				board.EP = Moves.FileMasks8[fenString.charAt(charIndex++) - 'a'];
	...
	*/
	private static Board arrayToBitboards(String[][] chessBoard, long WP, long WN, long WB, long WR, long WQ, long WK, long BP, long BN, long BB, long BR, long BQ, long BK) {
...
/*		board.WP=WP; board.WN=WN; board.WB=WB;
		...
		return new StandardBoard(WP, WR, WN, WB, WQ, WK, BP, BR, BN, BB, BQ, BK);
	}
